<%-- 
    ...
    Created on : 21/10/2020, 02:43:03 PM
    Author     : Ana Vasquez
--%>
              ...
              <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                  ...
                  <li class="dropdown active">
                    <a class="nav-link" href="#"><i class="far fa-credit-card"></i><span>Movimientos</span>
                    </a>
                  </li>
                          ...
                          <div class="table-responsive">
                            <table  class="table table-bordered table-md">
                              ...
                              <%
                                ...
                                ResultSet rs, rs2, rs3;
                                 ...
                                 try{
                                    ...
                                    while (rs.next()){             
                                        ...
                                        try{
                                            String sql2 = "SELECT * FROM pago WHERE id_Dep=? AND estado='Pagado'";
                                ...
                                %>
                                <tr>
                                    <td><%=rs2.getString("id_Pago")%></td>
                                    <td><%=rs2.getString("nomPago")%></td>
                                    <td><%=rs2.getString("fechaVen")%></td>
                                    <td><%=rs2.getDouble("monto")%></td>
                                    <td><a href="#" class="btn btn-primary">Detalles</a></td>
                                </tr>   
                        ...
                        <div class="card-body p-0">
                          <div class="table-responsive">
                            <table class="table table-striped table-md">
                                ...
                                <%
                                    try{
                                        String sql2 = "SELECT * FROM pago WHERE id_Dep=? AND estado='Atrasado'";
                        ...
                        <div class="card-body">
                          <div class="table-responsive">                             
                            <table id="datatable" class="table table-bordered table-md">      
                              ...
                              <%
                                    try{
                                        String sql2 = "SELECT * FROM pago WHERE id_Dep=? AND fechaVen>=NOW()";
                              ...
                              <tr>
                                ...
                                <td><%=rs2.getDouble("monto")%></td>
                                <td><%=rs2.getString("fechaVen")%></td>
                                <td class="btn btn-primary">  <div><%=rs2.getString("estado")%></div></td>
