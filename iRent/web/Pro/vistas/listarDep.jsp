            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <span><a  href="Dev2_DepControlador?&id_Pro=${id_Pro}&pass=${pass}&accion=add"  class="btn btn-icon btn-warning"> Agregar Departamento</a></span>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-exportar">
                                <a href="Dev2_DepControlador?&id_Pro=${id_Pro}&pass=${pass}&accion=detalles&id_Dep=${cli.getId_Dep()}"  class="btn btn-icon btn-success"><i class="fas fa-info-circle"></i> Detalles</a>
                                 <a href="Dev2_DepControlador?&id_Pro=${id_Pro}&pass=${pass}&accion=editar&id_Dep=${cli.getId_Dep()}"  class="btn btn-icon btn-primary"><i class="fas fa-edit"></i> Editar</a>
                                 <a onclick="funcion()" class="btn btn-icon btn-warning"><i class="fas fa-trash"></i> Eliminar</a>
...
if (result) {
       window.location = "Dev2_DepControlador?&id_Pro=${id_Pro}&pass=${pass}&accion=eliminar&id_Dep=${cli.getId_Dep()}";
}
}
</script>
        <!-- datatables JS -->
                ...
                buttons:[ 
                    ...
                    },
                    {
                        ...
                        customize: function ( doc ) {
                            ...
                            doc.content[1].table.widths = [50,70,70,70,70,70,70,70];
