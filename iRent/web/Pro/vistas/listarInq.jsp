            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <h4>Tabla de Inquilinos</h4> 
                  <span><a  href="Dev2_InqControlador?&id_Pro=${id_Pro}&pass=${pass}&accion=add"  class="btn btn-icon btn-warning"> Agregar Inquilino</a></span>
                </div>
                <div class="card-body">
                    ...
                    <tbody>
                        <%
                                ...
                                ResultSet rs, rs2, rs3;
                                 ...
                                 try{
                                    String sql = "SELECT * FROM inquilino  WHERE id_Pro=? AND estado=1 ";
                                ...
                                %>
                        <tr>
                            <td><%=rs.getInt("id_Inq") %></td>
                            <td><%=rs.getString("nom") %></td>
                            <td><%=rs.getString("ape") %></td>
                            <td><%=rs.getInt("tel") %></td>
                            <td><%=rs.getString("fechaIng") %></td>
                            <td><%=rs.getInt("tiempo") %></td>
                            <td><%=rs.getString("id_Dep") %></td>
                            <td  class="no-exportar">
                                <a href="Dev2_InqControlador?accion=editar&id_Inq=<%=rs.getInt("id_Inq") %>"  class="btn btn-icon btn-primary"><i class="fas fa-edit"></i>Editar</a>
                            </td>
            ...
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-header">
                  ...
                  <h4>Tabla de Inquilinos Inactivos</h4> 
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table id="datatables" class="table table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>Fecha de Ingreso</th>
                                <th>Meses de Contrato</th>
                                <th class="no-exportar">Departamento</th>
                                <th  class="no-exportar">Acción</th>
                            </tr>
                        </thead>                   
                    ...
                    <tbody>
                        <%
                                 try{
                                    String sql = "SELECT * FROM inquilino  WHERE id_Pro=? AND estado=2 ";
                        ...
                        <tr>
                            ...
                            <td><%=rs.getString("fechaIng") %></td>
                            <td><%=rs.getInt("tiempo") %></td>
                            <td class="no-exportar"><%=rs.getString("id_Dep") %></td>
                            <td  class="no-exportar">
                                <a href="Dev2_InqControlador?accion=editar&id_Inq=<%=rs.getInt("id_Inq") %>"  class="btn btn-icon btn-auccess"><i class="fas fa-edit"></i>Editar</a>
                            </td>
                ...
                buttons:[ 
                    {
                        ...
                        title: 'Reporte de Inquilinos Activos',
                    ...
                    },
                    {
                        ...
                        customize: function ( doc ) {
                            ...
                            doc.content[1].table.widths = [40,70,70,65,65,70,90];
