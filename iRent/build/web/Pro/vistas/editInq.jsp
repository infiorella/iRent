        ...
        <section class="section">
          <div class="section-body">
            ...
            <% 
                ...
                int id_Inq=Integer.parseInt((String)request.getAttribute("id_Inq"));
                Inquilino emp=(Inquilino)dao.list(id_Inq);
                 ...
                 <form  action="Dev2_InqControlador">
                     <div class="row">
                          ...
                          <div class="form-group col-4">
                            <label>ID: </label><input type="text" class="form-control"  name="id_Inq" value="<%=emp.getId_Inq()%>" />                    
                          </div>
                          <!--Nombre-->
                          <div class="form-group col-4">
                            <label>Nombre: </label><input type="text" class="form-control"  name="nom" value="<%=emp.getNom()%>" />                    
                          </div>
                          
                          <!--Apellido-->
                          <div class="form-group col-4">
                            <label>Apellido: </label> <input type="text" class="form-control" name="ape" value="<%=emp.getApe() %>" /> 
                          </div>
                        </div>  
                          ...
                          <!--Telefono-->
                          <div class="form-group col-4">
                              <label>Telefono: </label><input type="text" class="form-control"  name="tel" value="<%=emp.getTel() %>" />
                          </div>    
                             <!--Fecha Ingreso-->
                          <div class="form-group col-4">
                              <label>Fecha de Ingreso: </label><input type="date" class="form-control" name="fechaIng" value="<%=emp.getFechaIng() %>" />                         
                          </div>
                        
                             <!--Tiempo-->
                          <div class="form-group col-4">
                            <label>Tiempo de Alquiler: </label><input type="text" class="form-control" name="tiempo" value="<%=emp.getTiempo() %>" />                         
                          </div>
                          </div>  
                          ...
                          <div class="form-group col-4">
                            ...
                            <select name="id_Dep" class="form-control">
                                <option  value="<%=emp.getId_Dep() %>"><%=emp.getId_Dep() %></option>
                                <%
                                ...
                                ResultSet rs, rs2, rs3;
                                 ...
                                 con=cn.getConnection();                
                                 try{
                                    String sql = "SELECT * FROM departamento WHERE estado='Libre'";
                                    ...
                                    while (rs.next()){ 
                                %>
                                <option value="<%=rs.getString("id_Dep") %>"><%=rs.getString("id_Dep") %></option>
                                 <%  
                                        }
                                            rs.close();
                                            ps.close();
                          ...
                          <!--Pass-->
                          <div class="form-group col-4">
                              <label>Contraseña: </label> <input class="form-control" type="password" name="passe" value="<%=emp.getPass() %>" />
