          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form class="needs-validation" novalidate="" action="Dev2_DepControlador">
                    <div class="card-header">
                        <a href="Dev2_DepControlador?&id_Pro=${id_Pro}&pass=${pass}&accion=listar"><h4><i class="fas fa-arrow-left"></i></h4></a>
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                    ...
                    <div class="form-group">
                        <div class="row">
                          ...
                          <!--ID DEPARTAMENT-->
                            ...
                            <input name="id_Dep" type="text" class="form-control" required="">
                          </div>                                            
                          <!--Drmitorios-->
                          <div class="form-group col-4">
                            <label>Cantidad de Dormitorios: </label>
                            <input name="doDep" type="number" class="form-control">
                          </div>
                        
                          <!--Baños del departamento-->                          
                          <div class="form-group col-4">
                            <label>Cantidad de Baños: </label>
                            <input name="baDep" type="number" class="form-control">
                          </div>
                        </div>  
                        ...
                        <div class="row">
                          ...
                          <!--Area-->
                          <div class="form-group col-4">
                            <label>Area del Departamento: </label>
