          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form class="needs-validation" novalidate="" action="Dev2_PagoControlador">
                              ...
                              <%
                                ...
                                ResultSet rs, rs2, rs3;
                                 ...
                                 try{
                                    ...
                                    while (rs.next()){ 
                                %>
                                <input name="id_Pago" type="text" readonly="" class="form-control" value="<%=rs.getInt("MAX(id_Pago)")+1 %>">
                         <% }
                                            rs.close();
                                            ps.close();
                                        } catch (Exception e) {
                          ...
                          <div class="form-group col-4">
                            <label>Nombre: </label>
                            <select name="nomPago" required="" class="form-control">
                          ...
                          <div class="form-group col-4">
                            ...
                            <input name="fechaVen" type="date" class="form-control">
                          </div>
                        </div>
                          ...
                          <div class="form-group col-4">
                            ...
                            <select name="id_Dep" class="form-control">
                                ...
                                int id_Pro=Integer.parseInt(request.getParameter("id_Pro"));    
                                 try{
                                    String sql = "SELECT * FROM departamento WHERE id_Pro=? AND estado='Ocupado'";
