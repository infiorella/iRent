                ...
                <div class="card">
                  <form class="needs-validation" novalidate="" action="Dev2_InqControlador">
                    ...
                    <div class="card-body">
                          ...
                          <div class="form-group col-4">
                            ...
                            <select name="id_Dep" class="form-control">
                                ...
                                int id_Pro=Integer.parseInt(request.getParameter("id_Pro"));    
                                 try{
                                    String sql = "SELECT * FROM departamento WHERE id_Pro=? AND estado='Libre'";
                      ...
                      <div class="row">
                          <div class="card-footer text-right"><input type="submit" class="btn btn-primary" value="Agrega" name="accion" />                          
                          </div>
                      </div>
