...
<html>
 ...
 <%
                                ...
                                ResultSet rs, rs2, rs3;
                                 ...
                                 con=cn.getConnection(); 
                                 int a=Integer.parseInt(request.getParameter("id_Pago"));
                                 try{
                                    String sql = "SELECT * FROM pago WHERE id_Pago="+a;
                    ...
                    <div class="card-header has-icon">
                        <a href="Dev2_PagoControlador?accion=listar"><h4><i class="fas fa-arrow-left"></i></h4></a>
                       &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                       <h4>Editar Pago</h4>                        
                    </div>
                    <div class="card-body">
                
                 <form  action="Dev2_PagoControlador">
                     <div class="row">
                          <!--ID-->
                          <div class="form-group col-4">
                            <label>ID: </label><input type="text" class="form-control"  name="id_Pago" value="<%=rs.getInt("id_Pago") %>" />                    
                          </div>
                          <!--Nombre-->
                          <div class="form-group col-4">
                            <label>Nombre: </label><input type="text" class="form-control"  name="nomPago" value="<%=rs.getString("nomPago") %>" />                    
                          </div>
                          
                          <!--Apellido-->
                          <div class="form-group col-4">
                            <label>Fecha de Vencimiento: </label> <input type="date" class="form-control" name="fechaVen" value="<%=rs.getString("fechaVen") %>" /> 
                          </div>
                        </div>  
